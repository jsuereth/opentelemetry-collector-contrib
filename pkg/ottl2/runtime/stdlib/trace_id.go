...
var TraceIDType = runtime.NewStructureType("TraceID",
...
func (t traceIDVar) ConvertTo(tpe runtime.Type) (any, error) {
	panic("unimplemented")
}

// SetValue implements Var.
func (t traceIDVar) SetValue(v runtime.Val) error {
...
// Type implements Var.
func (t traceIDVar) Type() runtime.Type {
	return TraceIDType
}
...
func (t traceIDVar) GetField(field string) runtime.Val {
	if field == "string" {
		return NewStringVar(
			func() string {
...
func NewTraceIdVar(getter func() pcommon.TraceID,
	setter func(pcommon.TraceID)) runtime.Var {
	return traceIDVar{getter, setter}
}

func NewTraceIdVal(id pcommon.TraceID) runtime.Val {
	v := &id
