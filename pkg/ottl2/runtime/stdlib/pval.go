...
var PvalType = runtime.NewPrimitiveType("pcommon.Value")

type pvalVal pcommon.Value

// ConvertTo implements Val.
func (p pvalVal) ConvertTo(t runtime.Type) (any, error) {
	return convertPval(pcommon.Value(p), t)
}

func (p pvalVal) Type() runtime.Type {
	return PvalType
}
...
// pvalVal is a Var
func (p pvalVal) SetValue(v runtime.Val) error {
	return setPValue(pcommon.Value(p), v)
}

// GetIndex implements traits.Indexable
func (s pvalVal) GetIndex(index int64) runtime.Val {
...
func (s pvalVal) GetKey(key string) runtime.Val {
...
func NewPvalVar(v pcommon.Value) runtime.Var {
	return pvalVal(v)
}
...
func (p pvalVar) ConvertTo(t runtime.Type) (any, error) {
	return convertPval((func() pcommon.Value)(p)(), t)
}

// SetValue implements types.Var.
func (p pvalVar) SetValue(v runtime.Val) error {
	return setPValue((func() pcommon.Value)(p)(), v)
}

func (s pvalVar) GetIndex(index int64) runtime.Val {
	return NewLazyPval(func() pcommon.Value {
...
func (s pvalVar) GetKey(key string) runtime.Val {
	return NewLazyPval(func() pcommon.Value {
		v := (func() pcommon.Value)(s)()
...
func (p pvalVar) Type() runtime.Type {
	return PvalType
}
...
func NewLazyPval(v func() pcommon.Value) runtime.Var {
	return pvalVar(v)
}

func convertPval(p pcommon.Value, t runtime.Type) (any, error) {
	switch t {
	case BoolType:
...
func setPValue(p pcommon.Value, v runtime.Val) error {
	switch v.Type() {
	case PvalType:
