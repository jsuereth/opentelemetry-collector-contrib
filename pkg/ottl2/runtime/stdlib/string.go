...
var StringType = runtime.NewPrimitiveType("string")

type stringVal string

// Type implements Val.
func (s stringVal) Type() runtime.Type {
	return StringType
}

// Cast strings to valid other types.
func (s stringVal) ConvertTo(t runtime.Type) (any, error) {
...
func NewStringVal(v string) runtime.Val {
	return (stringVal)(v)
}
...
func (s string64Var) ConvertTo(t runtime.Type) (any, error) {
	return convertStringTo(s.getter(), t)
}

func (i string64Var) SetValue(v runtime.Val) error {
...
func (i string64Var) Type() runtime.Type {
	return StringType
}
...
func NewStringVar(getter func() string, setter func(string)) runtime.Var {
	return string64Var{getter, setter}
}

func convertStringTo(s string, t runtime.Type) (any, error) {
	switch t {
	case StringType:
		return s, nil
	}
