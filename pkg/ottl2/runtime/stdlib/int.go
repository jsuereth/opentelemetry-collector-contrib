...
var IntType = runtime.NewPrimitiveType("int")

type int64Val int64

// Type implements Val.
func (i int64Val) Type() runtime.Type {
	return IntType
}
...
func (i int64Val) ConvertTo(t runtime.Type) (any, error) {
	return convertIntTo(int64(i), t)
}

// Integers are addable
func (i int64Val) Add(o runtime.Val) runtime.Val {
...
func (i int64Val) Subtract(o runtime.Val) runtime.Val {
	rhs, err := o.ConvertTo(IntType)
	if err != nil {
		return NewErrorVal(err)
	}
...
func (i int64Val) Equals(o runtime.Val) bool {
	rhs, err := o.ConvertTo(IntType)
	if err != nil {
		return false
	}
...
func (i int64Val) LessThan(o runtime.Val) bool {
	rhs, err := o.ConvertTo(IntType)
	if err != nil {
		return false
	}
...
func NewIntVal(v int64) runtime.Val {
	return (int64Val)(v)
}
...
func (i int64Var) ConvertTo(t runtime.Type) (any, error) {
	return convertIntTo(i.getter(), t)
}

// SetValue implements Var.
func (i int64Var) SetValue(v runtime.Val) error {
...
// Type implements Var.
func (i int64Var) Type() runtime.Type {
	return IntType
}
...
func (i int64Var) Add(o runtime.Val) runtime.Val {
...
func NewIntVar(getter func() int64, setter func(int64)) runtime.Var {
	return int64Var{getter, setter}
}

func convertIntTo(i int64, t runtime.Type) (any, error) {
	switch t {
	case IntType:
		return int64(i), nil
	}
