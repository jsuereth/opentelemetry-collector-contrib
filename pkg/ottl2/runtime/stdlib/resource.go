...
var ResourceType runtime.Type = runtime.NewStructureType("pcommon.Resource", map[string]runtime.Type{
	"attributes":               PmapType,
...
func (r resourceVal) ConvertTo(t runtime.Type) (any, error) {
	if t == ResourceType {
...
func (r resourceVal) Type() runtime.Type {
	return ResourceType
}
...
func (r resourceVal) GetField(field string) runtime.Val {
	switch field {
	case "attributes":
...
func NewResourceVal(v ResourceContext) runtime.Val {
