...
var SpanKindEnum types.EnumProvider = spanKindEnum{}
var SpanKindType types.Type = EnumType(SpanKindEnum)

func NewSpanKindVal(v ptrace.SpanKind) types.Val {
...
func (e spanKindVar) GetField(field string) types.Val {
	switch field {
	case "string":
		return NewStringVar(
			func() string {
...
func (s spanKindVar) ConvertTo(t types.Type) (any, error) {
	return NewSpanKindVal(s.getter()).ConvertTo(t)
}

// SetValue implements types.Var.
func (s spanKindVar) SetValue(v types.Val) error {
...
func (s spanKindVar) Type() types.Type {
	return SpanKindType
}
...
func NewSpanKindVar(getter func() ptrace.SpanKind, setter func(ptrace.SpanKind)) types.Var {
