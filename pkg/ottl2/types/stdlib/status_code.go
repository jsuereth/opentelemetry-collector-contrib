...
var StatusCodeEnum types.EnumProvider = statusCodeEnum{}
var StatusCodeType types.Type = EnumType(StatusCodeEnum)

func NewStatusCodeVal(v ptrace.StatusCode) types.Val {
...
func (s statusCodeVar) ConvertTo(t types.Type) (any, error) {
	return NewStatusCodeVal(s.getter()).ConvertTo(t)
}

// SetValue implements types.Var.
func (s statusCodeVar) SetValue(v types.Val) error {
...
func (s statusCodeVar) Type() types.Type {
...
func NewStatusCodeVar(getter func() ptrace.StatusCode, setter func(ptrace.StatusCode)) types.Var {
